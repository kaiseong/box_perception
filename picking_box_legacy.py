...
and does NOT rotate the wrists in the first pass. In picking_box_legacy, yaw and x/y
...
SCRIPT_NAME = "picking_box_legacy"
...
# ---- Mobile base closed-loop alignment (picking_box_legacy) ----
...
class ContinuousLiveBoxView:
    ...
    def __init__(self, view_rotation: str, *, show: bool = True) -> None:
        ...
        self.window_name = "picking_box_legacy mobile align vision (q/ESC abort)"
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="vision-adjusted picking_box_legacy with combined M SE(2) alignment")
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "In picking_box_legacy this is combined with x/y alignment when both are enabled."
        ),
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help=(
            "In picking_box_legacy combined SE(2) alignment, suppress x/y translation "
